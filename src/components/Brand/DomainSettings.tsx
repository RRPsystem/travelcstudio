    ...
    <div className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-semibold text-sm text-blue-900 mb-1">AI Website Builder Domein Instellingen</h3>
            <p className="text-sm text-blue-700">
              Deze instellingen zijn voor je AI Website Builder website. Start met een gratis subdomain of koppel je eigen domein aan je website.
            </p>
          </div>
        </div>
      </div>
