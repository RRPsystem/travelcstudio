  ...
  try {
    ...
    return new Response(html, {
      ...
      headers: {
        ...
        \"Content-Security-Policy\": \"default-src 'self' https:; style-src 'self' 'unsafe-inline' https:; script-src 'self' 'unsafe-inline' https:; img-src 'self' data: https:; font-src 'self' data: https:;\"
      }
    });
  } catch (error: any) {
